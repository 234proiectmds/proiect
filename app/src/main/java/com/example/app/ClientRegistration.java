    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(ClientRegistration.this);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Client")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if(task.isSuccessful()){
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(ClientRegistration.this);
                                                            ...
                                                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(ClientRegistration.this,ClientVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            AlertForAll.ShowAlert(ClientRegistration.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
                                            }
        ...
        emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ClientRegistration.this, ClientLoginemail.class));
                finish();
            }
        });
        phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ClientRegistration.this, ClientLoginphone.class));
                finish();
            }
        });
    }
