...
public class AdminInregistrare extends AppCompatActivity {
    ...
    String firstName, lastName, email, password, confirmPassword, mobile, county, city, street, streetNumber, detailsAddress, zipCode, role = "Admin";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_inregistrare);
        ...
        signUp.setOnClickListener(v -> {
            ...
            if (isValid()) {
                final ProgressDialog mDialog = new ProgressDialog(AdminInregistrare.this);
                                    ...
                                    firebaseDatabase.getInstance().getReference("Admin")
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        AlertDialog.Builder builder = new AlertDialog.Builder(AdminInregistrare.this);
        ...
        emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AdminInregistrare.this, AdminLoginEmail.class));
                finish();
            }
        });
        phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminInregistrare.this, AdminLoginTelefon.class));
                finish();
            }
        });
    }
    ...
    public boolean isValid() {
        ...
        boolean isValid = false, isValideLastName = false, isValideFirstName = false, isValideEmail = false, isValidePassword = false, isValideConfirmPassword = false,
