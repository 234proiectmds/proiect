    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            signup.setOnClickListener(v -> {
                startActivity(new Intent(AdminLoginEmail.this, AdminInregistrare.class));
                finish();
            });
            Forgotpassword.setOnClickListener(v -> {
                startActivity(new Intent(AdminLoginEmail.this, AdminUitatParola.class));
                finish();
            });
            siginWithPhone.setOnClickListener(v -> {
                startActivity(new Intent(AdminLoginEmail.this, AdminLoginTelefon.class));
                finish();
            });
        } catch (Exception e) {
