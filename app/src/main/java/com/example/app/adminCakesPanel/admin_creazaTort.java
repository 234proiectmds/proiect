...
public class admin_creazaTort extends AppCompatActivity {

    ImageButton imageButton;
    Button creaza_tort;
    Spinner ttri;
    TextInputLayout desc, cant, prt;
    String descriere, cantitate, pret, torturi;
    Uri imageuri;
    ...
    String adminId, randomUID, oras, judet;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_creaza_tort);

        storage = FirebaseStorage.getInstance();
        storageReference = storage.getReference();
        ttri = (Spinner)findViewById(R.id.torturi);
        ...
        creaza_tort = (Button)findViewById(R.id.creaza);
        ...
        try{
            ...
            dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    creaza_tort.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            torturi = ttri.getSelectedItem().toString().trim();
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(admin_creazaTort.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("DetaliiTorturi")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(admin_creazaTort.this,
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(admin_creazaTort.this, e.getMessage(), Toast.LENGTH_SHORT)
                            .show();
                }
