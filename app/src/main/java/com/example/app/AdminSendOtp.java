...
public class AdminSendOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_send_otp);
    ...
    private void signInWithPhone(PhoneAuthCredential credential) {
        FAuth.signInWithCredential(credential).
                addOnCompleteListener(AdminSendOtp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Intent intent = new Intent(AdminSendOtp.this,AdminCakes_Navigation.class);
                            startActivity(intent);
                            finish();
                        }else{
                            AlertForAll.ShowAlert(AdminSendOtp.this,"Error",task.getException().getMessage());
                        }
                    }
                });
    }
