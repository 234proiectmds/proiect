...
public class ClientAcasaFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    RecyclerView recyclerView;
    private List<UpdateTortModel> updateCakeModelList;
    private ClientAcasaAdaptor adapter;
    String city, county;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_client_acasa, null);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    for (DataSnapshot snapshot2 : snapshot1.getChildren()) {
                        UpdateTortModel updateCakeModel = snapshot2.getValue(UpdateTortModel.class);
                        updateCakeModelList.add(updateCakeModel);
                    }
                }
                adapter = new ClientAcasaAdaptor(getContext(), updateCakeModelList);
